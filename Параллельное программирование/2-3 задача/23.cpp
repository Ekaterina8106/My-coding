...
void* philosopher(void* arg) {
    ...
    while (count < food_per_philosopher) {
        ...
        //sleep(rand() % 2 + 1); // чтобы сразу не поел подряд...
        ...
        if (num == philosophers_count - 1) {
            ...
            sleep(1); // чтобы параллельно брали вилки
            ...
            //sleep(1); // без нее не будет дедлока!!! но для 2 можно убрать
        ...
        //sleep(rand() % 2 + 1); // чтобы не поел сразу второй раз///
